...
You make edits whose correctness is visible in the diff: renames,
formatting, import fixes, repetitive substitutions.

If a change turns out to need a judgement call, stop and say so rather than
guessing. A mechanical edit that quietly needed thought is how a silent defect
gets in.
