...
3. **IN FLIGHT:** #39 (this PR -- re-cuts dead #38; #30/#35/#37/#38 all
   dead on unfixable identity/leak failures, don't touch any). Blocked on
   `lwb-lanes`: 2 AGREEs on file, both rejected on a same-repo-name
   segment collision -- flagged to the owner, gate defect not content.
   #29 (runbook, conflicts w/ main), #32 (#27 correction). Re-derive SHAs.
...
Generated: 2026-09-19 19:40 UTC
